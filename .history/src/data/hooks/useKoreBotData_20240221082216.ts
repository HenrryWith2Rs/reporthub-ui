...
export const useAppointmentData = (
  ...
  const queryKey = [botType, reportType, dateStart, dateEnd]; // Define a more specific query key
  ...
  console.log(`queryKey: ${queryKey.join('-')}`); // Log the query key for debugging
