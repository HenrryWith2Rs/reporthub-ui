...
const Dashboard = () => {
  ...
  const [apptDtldDataHolder, setApptDtldDataHolder] = useState<any | null>(null)
  const [apptSmmrDataHolder, setApptSmmrDataHolder] = useState<any | null>(null)
  const [billSmmrDataHolder, setBillSmmrDataHolder] = useState<any | null>(null)
  ...
  if (ApptSmmrIsFetching || ApptDtldIsFetching || BillSmmrIsFetching) {
    console.log("Loading...")
  } else if (ApptSmmrError || ApptDtldError || BillSmmrError) {
