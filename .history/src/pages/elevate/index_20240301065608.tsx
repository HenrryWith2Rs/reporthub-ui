...
const Properties = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'date', headerName: 'Date', flex: 1 },
    {
      ...
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
      field: 'groupOtb',
      headerName: 'Group OTB',
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
      field: 'groupBlock',
      headerName: 'Group Block',
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
    ...
    {
      field: 'bar8WeekRolling',
      headerName: 'Bar 8 Week Rolling',
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
      field: 'leftToSell',
      headerName: 'Left to Sell',
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
      field: 'totalOccPerc',
      headerName: 'Total Occ Perc',
      flex: 1,
      headerClassName: 'onTheBooksHeader',
    },
    {
